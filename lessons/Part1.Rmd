...
**🔔 Question:** what are some ways we could check that we have filtered down to the correct observations? Hint: `summary()` is a useful function for checking the range of values of a continuous variable like age. 
